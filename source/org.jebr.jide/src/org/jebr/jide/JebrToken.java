 ...
 * 
 * Depends On:
 * This file is essential to create a token map for the
 * RSyntaxTextAreaComponent developed by bobbylight and licensed under the GNU General Public License GPLv3  
 * License: 
...
public class JebrToken extends AbstractTokenMaker {
    ...
    public TokenMap getWordsToHighlight() {
        ...
        tokenMap.put("beginclass", Token.RESERVED_WORD);
        tokenMap.put("endclass", Token.RESERVED_WORD);
        tokenMap.put("begincons", Token.RESERVED_WORD); // Change to SEPERATOR 
        tokenMap.put("endcons", Token.RESERVED_WORD); // Change to SEPERATOR
        tokenMap.put("print", Token.RESERVED_WORD);
        tokenMap.put("constructor", Token.RESERVED_WORD);
        tokenMap.put("lambda", Token.RESERVED_WORD);
        ...
        tokenMap.put("routine", Token.RESERVED_WORD);//error
